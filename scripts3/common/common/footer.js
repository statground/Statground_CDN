    ...
    <div class="max-w-7xl mx-auto flex flex-col gap-3">
      <div class="flex flex-wrap items-center justify-between gap-y-2">
        <div class="flex flex-wrap gap-x-5 gap-y-2 font-medium">
          <a href="#" class="hover:underline"><span data-i18n="footer.about">통계마당 소개</span></a>
        </div>
        <div class="flex flex-wrap gap-x-5 gap-y-2 font-medium">
          <a href="#" class="hover:underline"><span data-i18n="footer.privacy">개인정보처리방침</span></a>
          <a href="#" class="hover:underline"><span data-i18n="footer.terms">이용약관</span></a>
        </div>
      </div>
...
async function set_footer() {
  const FOOTER_HTML = (await __sgLoadText('./partials/footer.html')) ?? __SG_DEFAULT_FOOTER_HTML;
