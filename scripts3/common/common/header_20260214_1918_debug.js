...
const __SG_DEFAULT_MENU_HTML = `<nav class="w-full px-6 py-4 flex justify-between items-center z-50 border-b border-transparent">
    <div class="flex items-center gap-6">
      ...
      <div class="hidden md:flex gap-4 text-sm font-bold opacity-70 hidden">
        <a href="#" class="hover:text-blue-600" data-sg-devmenu="1"><span data-i18n="nav.data">데이터</span></a>
        <a href="#" class="hover:text-blue-600" data-sg-devmenu="1"><span data-i18n="nav.workbench">워크벤치</span></a>
        <a href="#" class="hover:text-blue-600" data-sg-devmenu="1"><span data-i18n="nav.story">스토리</span></a>
        <a href="#" class="hover:text-blue-600" data-sg-devmenu="1"><span data-i18n="nav.academy">아카데미</span></a>
      </div>
    </div>
