...
(function () {
  function set_main() {
    ...
    // Tailwind CDN may not generate `dark:*` utilities for class strings inside external JS.
    // To keep this page readable, inject a scoped CSS fallback under #div_main when html has .dark.
    (function ensureSgwbDarkFallback() {
      try {
        if (document.getElementById("sgwb-dark-fallback-style")) return;
        const style = document.createElement("style");
        style.id = "sgwb-dark-fallback-style";
        style.textContent = `
          html.dark #div_main { color: rgb(226 232 240); } /* slate-200 */
          html.dark #div_main a { color: inherit; }
          html.dark #div_main .bg-white { background-color: rgba(2, 6, 23, 0.55) !important; } /* slate-950/55 */
          html.dark #div_main .bg-slate-50,
          html.dark #div_main .bg-slate-100 { background-color: rgba(2, 6, 23, 0.55) !important; }
          html.dark #div_main .border-slate-200 { border-color: rgba(51, 65, 85, 0.65) !important; } /* slate-700/65 */
          html.dark #div_main .border-slate-300 { border-color: rgba(51, 65, 85, 0.75) !important; }
          ...
          html.dark #div_main .text-slate-600 { color: rgb(148 163 184) !important; } /* slate-400 */
          html.dark #div_main .text-slate-500 { color: rgb(148 163 184) !important; }
          ...
          html.dark #div_main textarea::placeholder { color: rgba(148,163,184,0.9) !important; }
          html.dark #div_main .shadow-sm { box-shadow: 0 1px 2px 0 rgba(0,0,0,0.55) !important; }
        `;
