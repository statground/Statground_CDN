...
(function () {
  ...
  (function ensure_dark_fallback_css(){
    ...
    style.textContent = `
      ...
      html.dark #header,
      html.dark .sg-header{ background:#020617 !important; color:#e2e8f0 !important; border-color: rgba(148,163,184,0.18) !important; }
      html.dark footer,
      html.dark #div_footer,
      html.dark .sg-footer{ background:#020617 !important; color: rgba(226,232,240,0.8) !important; border-color: rgba(148,163,184,0.18) !important; }

      /* Main container */
      html.dark #div_main{ background: transparent !important; }
      html.dark #div_main .bg-white{ background: rgba(2,6,23,0.35) !important; }
      ...
      /* Inputs */
      html.dark #div_main input{ background: rgba(15,23,42,0.55) !important; color:#e2e8f0 !important; border-color: rgba(148,163,184,0.25) !important; }
      ...
      html.dark #div_main .hover\\:bg-slate-50:hover{ background: rgba(255,255,255,0.05) !important; }
      html.dark #div_main .dark\\:hover\\:bg-slate-950:hover{ background: rgba(255,255,255,0.05) !important; }
