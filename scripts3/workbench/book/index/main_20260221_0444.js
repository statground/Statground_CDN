...
// On this page, most Tailwind class strings are created inside external JS (React).
// cdn.tailwindcss.com sometimes fails to generate `dark:*` utilities for those classes.
// We keep the page readable by injecting a scoped CSS fallback that only activates when
// <html> has class "dark". This does NOT affect other pages because this file is only
// loaded on the Book Workbench.
(function sgwbInstallDarkFallback() {
  const STYLE_ID = "sgwb-dark-fallback-style";
  const css = `
    /* global page */
    html.dark body{
    ...
    html.dark footer a{ color: rgb(148 163 184) !important; }
    ...
    /* common tailwind surface tokens used in this page */
    ...
    html.dark #div_main .border-slate-300{
      border-color: rgba(51,65,85,0.75) !important; /* slate-700 */
    }

    /* text tokens */
    html.dark #div_main .text-slate-900{ color: rgb(241 245 249) !important; } /* slate-50 */
    html.dark #div_main .text-slate-800{ color: rgb(226 232 240) !important; }
    html.dark #div_main .text-slate-700{ color: rgb(203 213 225) !important; } /* slate-300 */
    html.dark #div_main .text-slate-600,
    html.dark #div_main .text-slate-500{ color: rgb(148 163 184) !important; } /* slate-400 */

    /* inputs */
    html.dark #div_main input,
    html.dark #div_main textarea,
    html.dark #div_main select{
      background-color: rgba(2,6,23,0.45) !important;
      border-color: rgba(51,65,85,0.75) !important;
      color: rgb(241 245 249) !important;
    }
    html.dark #div_main input::placeholder,
    html.dark #div_main textarea::placeholder{
      color: rgba(148,163,184,0.9) !important;
    }

    /* buttons (prevent "white blank button") */
    html.dark #div_main button{
      color: rgb(241 245 249);
    }
    html.dark #div_main button.bg-white{
      background-color: rgba(226,232,240,0.92) !important; /* slate-200-ish */
      color: rgb(15 23 42) !important; /* slate-900 */
      border-color: rgba(148,163,184,0.55) !important;
    }

    /* subtle shadow tuning */
    html.dark #div_main .shadow,
    html.dark #div_main .shadow-sm{
      box-shadow: 0 10px 15px -3px rgba(0,0,0,0.55), 0 4px 6px -4px rgba(0,0,0,0.55) !important;
    }
  `;
  ...
  // Keep in sync if theme toggles after React render.
  // (CSS is gated by html.dark, so we don't need to remove it.)
  try{
