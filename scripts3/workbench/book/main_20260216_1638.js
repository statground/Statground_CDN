...
React.createElement("div", { className: "mt-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm" },
  React.createElement("div", { className: "flex items-center justify-between px-6 py-5 border-b border-slate-200 dark:border-slate-800" },
    React.createElement("div", null,
      ...
      React.createElement("div", { className: "mt-1 text-xs text-slate-500 dark:text-slate-400" },
        searching ? t(lang, "wb.book.searching", "Searching...") : ((searchRes && searchRes.length) ? `${searchRes.length}` : "")
      )
    ),
    React.createElement("button", {
      onClick: doSearch,
...
React.createElement("div", { className: "mt-10 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm" },
              React.createElement("div", { className: "flex items-center justify-between px-6 py-5 border-b border-slate-200 dark:border-slate-800" },
                React.createElement("div", null,
                  React.createElement("div", { className: "text-lg font-black text-slate-900 dark:text-white" },
                  ...
                  React.createElement("div", { className: "mt-1 text-xs text-slate-500 dark:text-slate-400" },
                    isDesktop ? t(lang, "wb.book.recent.pc", "Desktop: latest 12") : t(lang, "wb.book.recent.mobile", "Mobile: latest 3")
                  )
                ),
                React.createElement("button", {
                  onClick: fetchRecent,
