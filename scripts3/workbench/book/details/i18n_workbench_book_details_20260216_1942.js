 ...
 * - Adds/overrides book-detail specific UI translations.
 * - Requires i18n_workbench.js to be loaded first (window.sg_workbench_i18n).
 *
 * NOTE:
 * - Do NOT require base.languages because some builds expose only {dict, resolveLangCode}.
 */
(function () {
  const base = window.sg_workbench_i18n;
  if (!base || !base.dict) {
    // Fallback stub (won't crash main)
  ...
  window.sg_workbench_i18n_book_details = { t, tf };
})();
