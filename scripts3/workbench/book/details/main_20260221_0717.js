        ...
        <a href="${link}" target="_blank" rel="noopener" class="block rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-3 hover:shadow-sm transition">
          <div class="flex gap-3">
            <div class="w-16 h-16 rounded-lg bg-slate-100 dark:bg-slate-800 shrink-0 overflow-hidden flex items-center justify-center">
              ${photo ? `<img src="${photo}" alt="" width="64" height="64" class="w-full h-full object-cover" loading="lazy" decoding="async" />` : `<div class="w-full h-full"></div>`}
            </div>
    ...
    root.innerHTML = `
      ...
      <div class="max-w-6xl mx-auto">
        <div class="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 shadow-sm">
            ...
            <div class="col-span-12 md:col-span-8">
              ...
              <div class="mt-8">
                ...
                <div class="mt-8 flex justify-center">
                  <div class="sg-adpick-card bg-white rounded-2xl p-4 shadow-sm">
                    <a href="#" target="_blank" rel="noopener">
                      <img src="https://cdn.jsdelivr.net/gh/statground/Statground_CDN/images/common/affiliates/adpick.png"
                           alt="Adpick" width="125" height="125" class="w-[125px] h-[125px] object-contain" loading="lazy" decoding="async" />
                    </a>
                  </div>
                </div>
              </div>
          ...
          <div class="mt-10">
            <div id="sg_shotalk_box" class="w-full min-h-[220px]">
              <div class="text-sm text-slate-600 dark:text-slate-300">${esc(t(uiLang, "wb.book.details.aff_loading"))}</div>
              <div class="mt-3 grid grid-cols-1 md:grid-cols-3 gap-4">
                <div class="h-24 rounded-xl bg-slate-100 dark:bg-slate-800 animate-pulse"></div>
                <div class="h-24 rounded-xl bg-slate-100 dark:bg-slate-800 animate-pulse"></div>
                <div class="h-24 rounded-xl bg-slate-100 dark:bg-slate-800 animate-pulse"></div>
              </div>
            </div>
