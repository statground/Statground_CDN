 ...
 * - Book detail UI translations for ALL supported languages (aligned with i18n_workbench_book.js).
 * - Robust against language variants (ko-KR, en-US, zh-CN, zh-TW, etc.)
 * - Robust against load order (retries until sg_workbench_i18n is ready).
 */
(function () {
  const PATCH = {
  "ar": {
    ...
    "wb.book.details.no_isbn": "ISBN مفقود.",
    "wb.book.details.aff_title": "Affiliate",
    "wb.book.details.aff_loading": "Searching related products...",
    "wb.book.details.aff_none": "No matching products."
  },
  "de": {
    ...
    "wb.book.details.no_isbn": "ISBN fehlt.",
    "wb.book.details.aff_title": "Affiliate",
    "wb.book.details.aff_loading": "Searching related products...",
    "wb.book.details.aff_none": "No matching products."
  },
  "en": {
    ...
    "wb.book.details.no_isbn": "Missing ISBN.",
    "wb.book.details.aff_title": "Affiliate",
    "wb.book.details.aff_loading": "Searching related products...",
    "wb.book.details.aff_none": "No matching products."
  },
  "es": {
    ...
    "wb.book.details.no_isbn": "Falta el ISBN.",
    "wb.book.details.aff_title": "Affiliate",
    "wb.book.details.aff_loading": "Searching related products...",
    "wb.book.details.aff_none": "No matching products."
  },
  "fil": {
    ...
    "wb.book.details.no_isbn": "Walang ISBN.",
    "wb.book.details.aff_title": "Affiliate",
    "wb.book.details.aff_loading": "Searching related products...",
    "wb.book.details.aff_none": "No matching products."
  },
  "fr": {
    ...
    "wb.book.details.no_isbn": "ISBN manquant.",
    "wb.book.details.aff_title": "Affiliate",
    "wb.book.details.aff_loading": "Searching related products...",
    "wb.book.details.aff_none": "No matching products."
  },
  "hi": {
    ...
    "wb.book.details.no_isbn": "ISBN नहीं है।",
    "wb.book.details.aff_title": "Affiliate",
    "wb.book.details.aff_loading": "Searching related products...",
    "wb.book.details.aff_none": "No matching products."
  },
  "id": {
    ...
    "wb.book.details.no_isbn": "ISBN tidak ada.",
    "wb.book.details.aff_title": "Affiliate",
    "wb.book.details.aff_loading": "Searching related products...",
    "wb.book.details.aff_none": "No matching products."
  },
  "it": {
    ...
    "wb.book.details.no_isbn": "ISBN mancante.",
    "wb.book.details.aff_title": "Affiliate",
    "wb.book.details.aff_loading": "Searching related products...",
    "wb.book.details.aff_none": "No matching products."
  },
  "ja": {
    ...
    "wb.book.details.no_isbn": "ISBN がありません。",
    "wb.book.details.aff_title": "Affiliate",
    "wb.book.details.aff_loading": "Searching related products...",
    "wb.book.details.aff_none": "No matching products."
  },
  "ko": {
    ...
    "wb.book.details.no_isbn": "ISBN이 없습니다.",
    "wb.book.details.aff_title": "추천 상품",
    "wb.book.details.aff_loading": "관련 상품을 찾는 중...",
    "wb.book.details.aff_none": "일치하는 상품이 없습니다."
  },
  "ms": {
    ...
    "wb.book.details.no_isbn": "ISBN tiada.",
    "wb.book.details.aff_title": "Affiliate",
    "wb.book.details.aff_loading": "Searching related products...",
    "wb.book.details.aff_none": "No matching products."
  },
  "nl": {
    ...
    "wb.book.details.no_isbn": "ISBN ontbreekt.",
    "wb.book.details.aff_title": "Affiliate",
    "wb.book.details.aff_loading": "Searching related products...",
    "wb.book.details.aff_none": "No matching products."
  },
  "pl": {
    ...
    "wb.book.details.no_isbn": "Brak ISBN.",
    "wb.book.details.aff_title": "Affiliate",
    "wb.book.details.aff_loading": "Searching related products...",
    "wb.book.details.aff_none": "No matching products."
  },
  "pt-BR": {
    ...
    "wb.book.details.no_isbn": "ISBN ausente.",
    "wb.book.details.aff_title": "Affiliate",
    "wb.book.details.aff_loading": "Searching related products...",
    "wb.book.details.aff_none": "No matching products."
  },
  "ru": {
    ...
    "wb.book.details.no_isbn": "ISBN отсутствует.",
    "wb.book.details.aff_title": "Affiliate",
    "wb.book.details.aff_loading": "Searching related products...",
    "wb.book.details.aff_none": "No matching products."
  },
  "sv": {
    ...
    "wb.book.details.no_isbn": "ISBN saknas.",
    "wb.book.details.aff_title": "Affiliate",
    "wb.book.details.aff_loading": "Searching related products...",
    "wb.book.details.aff_none": "No matching products."
  },
  "th": {
    ...
    "wb.book.details.no_isbn": "ไม่มี ISBN",
    "wb.book.details.aff_title": "Affiliate",
    "wb.book.details.aff_loading": "Searching related products...",
    "wb.book.details.aff_none": "No matching products."
  },
  "tr": {
    ...
    "wb.book.details.no_isbn": "ISBN eksik.",
    "wb.book.details.aff_title": "Affiliate",
    "wb.book.details.aff_loading": "Searching related products...",
    "wb.book.details.aff_none": "No matching products."
  },
  "uk": {
    ...
    "wb.book.details.no_isbn": "Немає ISBN.",
    "wb.book.details.aff_title": "Affiliate",
    "wb.book.details.aff_loading": "Searching related products...",
    "wb.book.details.aff_none": "No matching products."
  },
  "vi": {
    ...
    "wb.book.details.no_isbn": "Thiếu ISBN.",
    "wb.book.details.aff_title": "Affiliate",
    "wb.book.details.aff_loading": "Searching related products...",
    "wb.book.details.aff_none": "No matching products."
  },
  "zh-Hans": {
    ...
    "wb.book.details.no_isbn": "缺少 ISBN。",
    "wb.book.details.aff_title": "Affiliate",
    "wb.book.details.aff_loading": "Searching related products...",
    "wb.book.details.aff_none": "No matching products."
  },
  ...
  function canonicalize(code) {
    ...
    if (low === "pt_br" || low === "pt-br" || low.startsWith("pt-")) return "pt-BR";
    ...
    if (two === "tr") return "tr";
    if (two === "uk") return "uk";
    if (two === "fi") return "fil";
    return "en";
  }

  function applyPatch(base) {
    for (const canon in PATCH) {
      if (!base.dict[canon]) base.dict[canon] = {};
      Object.assign(base.dict[canon], PATCH[canon]);
    }

    if (Array.isArray(base.languages)) {
      base.languages.forEach((code) => {
        const canon = canonicalize(code);
        if (!PATCH[canon]) return;
        if (!base.dict[code]) base.dict[code] = {};
        Object.assign(base.dict[code], PATCH[canon]);
      });
    }

    function resolve(lang) {
      return base.resolveLangCode ? base.resolveLangCode(lang) : lang;
    }

    function t(lang, key) {
      const raw = lang;
      const L = resolve(lang);
      const candidates = [];
      if (L) candidates.push(L);
      if (raw && raw !== L) candidates.push(raw);
      candidates.push(canonicalize(L || raw));
      candidates.push("en");
      candidates.push("ko");
    ...
    window.sg_workbench_i18n_book_details = { t, tf, canonicalize };
  }
  ...
  function initWithRetry(tries) {
    ...
    if (tries <= 0) {
      window.sg_workbench_i18n_book_details = {
        t: function (_lang, key) { return key; },
        tf: function (_lang, key, vars) {
          let s = key;
    ...
    setTimeout(() => initWithRetry(tries - 1), 50);
  }
