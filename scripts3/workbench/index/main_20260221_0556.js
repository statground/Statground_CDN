...
function set_main() {
  window.__SG_WB_MAIN_VERSION__ = "workbench-main-toned-v2-20260221";
  try { console.log("[Statground] workbench main version:", window.__SG_WB_MAIN_VERSION__); } catch(e) {}
  ...
  const Card = ({ href, title, desc, icon, cta }) => (
    <a
      href={href}
      className="group block rounded-2xl border border-slate-200 dark:border-slate-800/80 bg-white/80 dark:bg-slate-950/35 p-6 shadow-sm hover:shadow-md dark:hover:bg-slate-900/40 transition"
    >
    ...
    return (
      <div className="w-full">
        <div className="max-w-6xl mx-auto px-2 md:px-0">
          <div className="relative overflow-hidden rounded-3xl border border-slate-200 dark:border-slate-800/80 bg-white/70 dark:bg-slate-950/30 shadow-sm">
            <div className="absolute inset-0 pointer-events-none">
              <div className="absolute -top-24 -right-24 w-80 h-80 rounded-full bg-slate-200/40 dark:bg-slate-700/25 blur-3xl" />
              <div className="absolute -bottom-24 -left-24 w-80 h-80 rounded-full bg-slate-200/30 dark:bg-slate-700/20 blur-3xl" />
            </div>
