// Section
function html_section(header, title, subtitle, contentID){
...
function insert_people(){
	...
	html_section("People", "만든 사람들", "통계마당을 만들어나가고 있는 사람들이에요.", "div_people");
...
function insert_partnership(){
	...
	html_section("Partnerships", "파트너십과 주요 고객사", "통계마당과 함께 미래를 만들어가는 업체들입니다.", "div_partnership");
	...
	getHtml(title="(주)LG CNS",
			description="Data lake 포털 구축 아웃소싱 등",
