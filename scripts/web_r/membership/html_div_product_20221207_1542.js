function html_div_product(name="정회원", msg="", msg2="", price=100000, div_id=1, product_id="")
{
	...
	html += html_button(color="warning", msg="카드 결제",
						onclick='request_order_id(\'' + product_id + '\', \'card\'')
	html += html_button(color="warning", msg="가상계좌",
						onclick='request_order_id(\'' + product_id + '\', \'va\'')
	html += '<br/>'
	html += html_button(color="warning", msg="계좌이체",
						onclick='request_order_id(\'' + product_id + '\', \'account\'')
