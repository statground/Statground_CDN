function html_div_product(name="정회원", msg="", msg2="", price=100000, div_id=1, product_id="", email="")
{
	...
	html += html_button(color="warning", msg="카드 결제",
								onclick='request_order_id(\'' + product_id + '\', \'13381046-8486-11ed-a1eb-0242ac120002\', \'card\', \'' + email + '\')')
	html += html_button(color="warning", msg="가상계좌",
								onclick='request_order_id(\'' + product_id + '\', \'13381046-8486-11ed-a1eb-0242ac120002\', \'va\', \'' + email + '\')')
	html += '<br/>'
	html += html_button(color="warning", msg="계좌이체",
								onclick='request_order_id(\'' + product_id + '\', \'13381046-8486-11ed-a1eb-0242ac120002\', \'account\', \'' + email + '\')')
