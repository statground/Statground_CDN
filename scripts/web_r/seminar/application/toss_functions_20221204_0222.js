...
function func_billing_card(clientKey, orderID, username, successURL, failedURL) {
...
function func_billing_va(clientKey, orderID, username, successURL, failedURL) {
	var tossPayments = TossPayments(clientKey)
...
function func_billing_account(clientKey, orderID, username, successURL, failedURL) {
	var tossPayments = TossPayments(clientKey)
...
function func_billing_mobile(clientKey, orderID, username, successURL, failedURL) {
	var tossPayments = TossPayments(clientKey)
...
function func_billing_voucher(clientKey, orderID, username, successURL, failedURL) {
	var tossPayments = TossPayments(clientKey)
