function payment_init_html(email, username, phone)
{
	...
	result_url = "/seminar/application/result/"
	...
	if ( email == "None" || username == "None" || phone == "None" ) {
		...
		html = html_button(color="warning", msg="카드 결제",
						   onclick='request_order_id(\'' + product_id + '\', \'' + result_url + '\', \'card\', \'' + email + '\', \'' + username + '\', \'' + phone + '\')')
		html += "&nbsp;"
		html += html_button(color="warning", msg="가상계좌",
							onclick='request_order_id(\'' + product_id + '\', \'' + result_url + '\', \'va\', \'' + email + '\', \'' + username + '\', \'' + phone + '\')')
		html += "&nbsp;"
		html += html_button(color="warning", msg="계좌이체",
							onclick='request_order_id(\'' + product_id + '\', \'' + result_url + '\', \'account\', \'' + email + '\', \'' + username + '\', \'' + phone + '\')')
