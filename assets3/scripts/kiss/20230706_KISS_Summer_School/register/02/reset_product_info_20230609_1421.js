...
function reset_product_info() {
	...
	// 1일차, 2일차, 학생
		...
		product_id = "e970d528-fa36-11ed-be56-0242ac120002"
		price_days_1 = 120000
		price_days_2 = 0

	} else if (btn_days_1 == 1 && btn_days_2 == 0 && chk_student == 1) { 
		product_id = "e970d529-fa36-11ed-be56-0242ac120002"
		price_days_1 = 80000
		price_days_2 = 0

	} else if (btn_days_1 == 0 && btn_days_2 == 1 && chk_student == 0) { 
		product_id = "65c5bd96-fa37-11ed-be56-0242ac120002"
		price_days_1 = 0
		price_days_2 = 120000

	} else if (btn_days_1 == 0 && btn_days_2 == 1 && chk_student == 1) { 
		product_id = "65c5bae4-fa37-11ed-be56-0242ac120002"
		price_days_1 = 0
		price_days_2 = 80000
