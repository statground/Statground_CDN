		...
		return (
			<div class="container mx-auto">
				<div class="grid lg:grid-cols-3 md:grid-cols-1 mx-auto">
					...
					<br/>
					<Div_Sub title="일 평균 방문자 수" content={props.result.cnt_visitor} unit="명" svg="https://cdn.jsdelivr.net/gh/statground/Statground_CDN/assets3/images/svg/pageview.svg" />
					<br/>
					<Div_Sub title="총 페이지 뷰" content={props.result.cnt_pageview} unit="건" svg="https://cdn.jsdelivr.net/gh/statground/Statground_CDN/assets3/images/svg/visitors.svg" />
				</div>
			</div>
		)
	}
