function btn_payment_show(mode, email) {
	...
	if (mode == "1") {
		...
		ReactDOM.render(<Div_button_paymnets product_id={product_id} price={price} email={email} />, document.getElementById("div_buttons_payment_1"))
		...
		ReactDOM.render(<Div_button_paymnets product_id={product_id} price={price} email={email} />, document.getElementById("div_buttons_payment_2"))
		ReactDOM.render(<Div_button_paymnets_clear />, document.getElementById("div_buttons_payment_3"))
	} else if (mode == "3") {
		...
		ReactDOM.render(<Div_button_paymnets_clear />, document.getElementById("div_buttons_payment_1"))
		ReactDOM.render(<Div_button_paymnets_clear />, document.getElementById("div_buttons_payment_2"))
		ReactDOM.render(<Div_button_paymnets product_id={product_id} price={price} email={email} />, document.getElementById("div_buttons_payment_3"))
	}
}