...
async function get_graph_payments(type)
{
	...
	if (type == "daily") {
		...
		div_graph_monthly.className = "p-4 rounded-lg bg-gray-50 w-full"
		div_graph_yearly.className = "hidden p-4 rounded-lg bg-gray-50 w-full"
		...
		div_graph_monthly.className = "hidden p-4 rounded-lg bg-gray-50 w-full"
		div_graph_yearly.className = "p-4 rounded-lg bg-gray-50 w-full"
