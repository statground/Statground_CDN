(function () {
  ...
  function cardHTML(href, icon, title, desc, cta) {
    return [
      '<a href="' + href + '" class="group block rounded-2xl border border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 p-6 shadow-sm hover:shadow-md transition">',
