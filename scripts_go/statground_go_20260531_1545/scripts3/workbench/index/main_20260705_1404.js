(function () {
  ...
  function render(langOverride) {
    ...
    const shoppingHref = "/" + encodeURIComponent(lang) + "/shopping/";
    ...
    const cards = [
      ...
      cardHTML(shoppingHref, iconShopping(), t(lang, "wb.card.shopping.title", "Shopping Price Insight"), t(lang, "wb.card.shopping.desc", "Analyze price bands, discount pressure, and seller opportunity signals."), cta)
    ];
    const gridClass = "mt-8 grid grid-cols-1 lg:grid-cols-3 gap-4";
