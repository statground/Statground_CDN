(function () {
  ...
  function productCard(lang, item) {
    ...
    return [
      '<article class="flex h-full min-w-0 flex-col overflow-hidden rounded-lg border border-slate-200 bg-white p-3 shadow-sm">',
      ...
      '<div class="flex min-w-0 justify-between gap-3"><dt class="shrink-0 font-bold text-slate-500">' + esc(t(lang, "basis")) + '</dt><dd class="min-w-0 break-words text-right [overflow-wrap:anywhere]">' + esc(t(lang, "basis")) + '</dd></div>',
