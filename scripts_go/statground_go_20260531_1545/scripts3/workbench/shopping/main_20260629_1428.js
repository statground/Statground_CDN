(function () {
  ...
  function categoryTabHTML(lang, value, title, sub, active) {
    return [
      '<a href="' + esc(categoryHref(lang, value || "")) + '" data-top-category="' + esc(value || "") + '" aria-current="' + (active ? "page" : "false") + '" class="group flex min-w-0 flex-col items-center gap-2 rounded-lg px-1.5 py-2 text-center transition focus:outline-none focus:ring-2 focus:ring-blue-300">',
  ...
  function render(langOverride) {
    ...
    const radarCategory = currentCategorySlug();
  ...
  window.addEventListener("popstate", function () {
    ...
    if (appEl && radar) {
      renderLoadedRadar(displayLang(routeLang()), radar, appEl);
    }
  });
