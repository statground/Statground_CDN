(function () {
  ...
  function chartRailHTML(lang, boxes) {
    ...
    return [
      ...
      '<div class="mb-2 hidden text-xs font-bold text-slate-500" data-chart-rail-hint>' + esc(t(lang, "chartRailHint")) + '</div>',
      '<div class="relative">',
  ...
  function setupChartRails(appEl) {
    ...
    scope.querySelectorAll("[data-chart-rail]").forEach((rail) => {
      ...
      const hint = rail.querySelector("[data-chart-rail-hint]");
