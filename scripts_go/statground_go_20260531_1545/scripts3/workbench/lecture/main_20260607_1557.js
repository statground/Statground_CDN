            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-12">
              ...
              <div class="md:col-span-8">
                ...
                <div class="mt-5 flex flex-wrap gap-3">
                  <a href="${esc(item.course_url || "https://www.inflearn.com/")}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center rounded-lg bg-blue-600 px-5 py-3 text-sm font-extrabold text-white hover:bg-blue-700">${esc(t(langCode, "openOriginal"))}</a>
                </div>
              </div>
            </div>
