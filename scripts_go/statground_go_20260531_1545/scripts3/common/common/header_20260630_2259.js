...
(function () {
  ...
  function socialSVG(kind) {
    const common = 'class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"';
    switch (kind) {
      case "facebook-group":
        return `<svg ${common}><path d="M12 2.6a9.4 9.4 0 1 0 0 18.8 9.4 9.4 0 0 0 0-18.8Zm2.5 5.6h-1.4c-.8 0-1 .5-1 1v1.3h2.3l-.3 2.4h-2v6h-2.5v-6H7.5v-2.4h2.1V9c0-2.1 1.3-3.2 3.1-3.2.9 0 1.6.1 1.8.1v2.3Z"></path></svg>`;
      case "facebook-page":
        return `<svg ${common}><path d="M12 2.6a9.4 9.4 0 1 0 0 18.8 9.4 9.4 0 0 0 0-18.8Zm2.2 8.8-.3 2h-1.6v5.5h-2.2v-5.5H8.6v-2h1.5V9.9c0-1.7 1-2.7 2.6-2.7.8 0 1.6.1 1.6.1v1.8h-.9c-.9 0-1.1.5-1.1 1.1v1.2h1.9Z"></path></svg>`;
      case "x":
        return `<svg ${common}><path d="M14.5 10.4 21.4 2h-1.6l-6 7.3L9 2H3.5l7.2 10.5L3.5 21h1.6l6.3-7.4 5 7.4h5.5l-7.4-10.6Zm-2.2 2.5-.7-1L5.8 3.2h2.4l4.7 7 .7 1 6.1 8.8h-2.4l-5-7.1Z"></path></svg>`;
      case "instagram":
        return `<svg ${common}><path d="M7.8 2.5h8.4a5.3 5.3 0 0 1 5.3 5.3v8.4a5.3 5.3 0 0 1-5.3 5.3H7.8a5.3 5.3 0 0 1-5.3-5.3V7.8a5.3 5.3 0 0 1 5.3-5.3Zm0 1.9a3.4 3.4 0 0 0-3.4 3.4v8.4a3.4 3.4 0 0 0 3.4 3.4h8.4a3.4 3.4 0 0 0 3.4-3.4V7.8a3.4 3.4 0 0 0-3.4-3.4H7.8Zm4.2 3.3a4.3 4.3 0 1 1 0 8.6 4.3 4.3 0 0 1 0-8.6Zm0 1.9a2.4 2.4 0 1 0 0 4.8 2.4 2.4 0 0 0 0-4.8Zm4.5-2.9a1 1 0 1 1 0 2 1 1 0 0 1 0-2Z"></path></svg>`;
      case "linkedin":
        return `<svg ${common}><path d="M5.2 3.7a2 2 0 1 1 0 4.1 2 2 0 0 1 0-4.1ZM3.5 9.4h3.4v10.9H3.5V9.4Zm5.6 0h3.2v1.5h.1c.4-.8 1.5-1.8 3.1-1.8 3.4 0 4 2.2 4 5.1v6.1h-3.4v-5.4c0-1.3 0-3-1.8-3s-2.1 1.4-2.1 2.9v5.5H9.1V9.4Z"></path></svg>`;
      case "threads":
        return `<svg ${common}><path d="M12.1 2.5c5.2 0 8.3 3.4 8.3 9.5 0 6-3.2 9.5-8.5 9.5-5.1 0-8.3-3.5-8.3-9.5 0-6.1 3.2-9.5 8.5-9.5Zm0 2c-4 0-6.3 2.8-6.3 7.5 0 4.6 2.3 7.5 6.1 7.5 4 0 6.3-2.8 6.3-7.5 0-4.7-2.3-7.5-6.1-7.5Zm.2 3c2.2 0 3.8 1.1 4.4 3.2l-1.9.5c-.3-1.2-1.1-1.9-2.5-1.9-1.3 0-2.3.7-2.7 2.1.6-.3 1.4-.5 2.4-.5 2.7 0 4.3 1.3 4.3 3.2 0 2.1-1.8 3.5-4.2 3.5-2.2 0-3.8-1.1-3.8-2.8 0-1.7 1.5-2.8 3.8-2.8.8 0 1.5.1 2.1.3-.2-1.9-.9-2.9-2.1-2.9-1.1 0-1.8.6-2.1 1.7l-1.9-.5c.6-2 2.1-3.1 4.2-3.1Zm-.1 6c-1.2 0-1.9.5-1.9 1.2 0 .8.7 1.3 1.8 1.3 1.3 0 2.1-.6 2.1-1.5 0-.6-.8-1-2-1Z"></path></svg>`;
      default:
