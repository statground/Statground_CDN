            ...
            return `
              <button class="w-full flex items-center justify-between gap-3 px-5 py-3 text-left transition hover:bg-slate-100"
                ...
                <div class="flex min-w-0 items-center gap-3">
                  <span class="inline-flex h-8 w-8 shrink-0 items-center justify-center overflow-hidden rounded-full border border-slate-200 bg-white text-lg leading-none shadow-sm">${l.flag || '🌐'}</span>
                  <div class="min-w-0">
